...
#let name = "Alexander Sauceda"
#let locale-catalog-page-numbering-style = context { "Alexander Sauceda - Page " + str(here().page()) + " of " + str(counter(page).final().first()) + "" }
...
#let connections-list = (
  ...
  [#box(original-link("https://linkedin.com/in/alexander-matthew-sauceda")[#fa-icon("linkedin", size: 0.9em) #h(0.05cm)alexander-matthew-sauceda])],
  [#box(original-link("https://github.com/alesauce")[#fa-icon("github", size: 0.9em) #h(0.05cm)alesauce])],
)
...
#one-col-entry(
  content: [A dedicated and versatile backend developer looking to utilize API-driven development, system architecture, and software engineering skills learned through 8+ years with Amazon.]
)
...
#[_Amazon Photos, Trust & Safety Engineering_]
  ],
  right-content: [
    #[_Seattle, WA_]
...
#[_Amazon Explore, Business Development_]
  ],
  right-content: [
    #[_Seattle, WA_]
...
#one-col-entry(
  content: [
    #v(design-highlights-top-margin);#highlights([Designed and implemented new analytics tooling, enabling business development teams to proactively identify and correct poor customer experiences, resulting in a customer satisfaction score increase of \~4\%.],[Developed a new onboarding guide for partners selling “experiences” and reduced onboarding time by 10\% for new sellers.],[Investigated customer-facing issues and provided root-cause analysis to the software development team which resulted in a reduction of software-related defects from 9\% to 1.5\%.],[Developed a new org standard process for remediating seller connectivity issues.],)
  ],
)
...
#[_Amazon Fulfillment/Supply Chain Execution_]
  ],
  right-content: [
    #[_Seattle, WA/Phoenix, AZ_]

#[_June 2016 – Aug 2020_]
  ],
)
#one-col-entry(
  content: [
